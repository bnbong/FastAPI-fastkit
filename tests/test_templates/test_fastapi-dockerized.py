# --------------------------------------------------------------------------
# Testcases of fastapi-dockerized template.
#
...
class TestFastAPIDockerized:
    ...
    def test_startdemo_fastapi_dockerized(self, temp_dir: str) -> None:
        # given
        project_name = "test-dockerized"
        author = "test-author"
        author_email = "test@example.com"
        description = "A test FastAPI project with Docker support"

        # when
        result = self.runner.invoke(
            fastkit_cli,
            ["startdemo", "fastapi-dockerized"],
        ...
        assert (project_path / "Dockerfile").exists(), "Dockerfile not found"
